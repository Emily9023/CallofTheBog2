...
public abstract class InteractiveTileObject {
    ...
    public InteractiveTileObject(World world, TiledMap map, Rectangle bounds){
        ...
        bdef.position.set((bounds.getX() + bounds.getWidth() / 2) / CallofTheBog.PPM, (bounds.getY() + bounds.getHeight() / 2) / CallofTheBog.PPM); //sets the position of where the body is (position of the rect
